...
class DetailsBottomSheet : BaseBottomSheetDialogFragment(
    ...
    private var musicPlayControlImageView: ImageView by notNull()
    ...
    private fun initViewModel() {
        ...
        viewModel.changeMusicConfig.observe(viewLifecycleOwner) {
            resManager.drawable(it)?.let {
                musicPlayControlImageView.setImageDrawable(it)
            }
        }
    ...
    private fun initListener() {
        ...
        musicPlayControlImageView.setOnClickListener {
            viewModel.changeMusicControl()
        }
    ...
    private fun initViews() {
        ...
        musicPlayControlImageView = findViewById(R.id.musicPlayControlImageView)
